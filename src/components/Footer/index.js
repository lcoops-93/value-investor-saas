          ...
          <Container>
            <Row type="flex" justify="space-between">
              <Col lg={10} md={10} sm={12} xs={24}>
                ...
                <a href="mailto:mindsetfacts@gmail.com">
        ...
        <S.Extra>
          <Container border="true">
            ...
            >
              ...
              <S.FooterContainer>
                <SocialLink
                  href="https://twitter.com/cops_lee"
                  src="twitter.svg"
                />
                <SocialLink
                  href="https://www.linkedin.com/in/lee-cooper-9a4288158/"
                  src="linkedin.svg"
                />
                <SocialLink
                  href="https://www.instagram.com/businessideas365/"
                  src="instagram.svg"
                />
              </S.FooterContainer>
            </Row>
